...
export default function Footer({change}){
    const data = [

        {
            ...
            content:'네, 당연하죠. 기술적인 부분을 모르겠다면 자신에 대한 내용을 더욱 많이 써주세요.',
        },
        {
            id:1,
            title:"선발기준이 어떻게 되나요?",
        ...
        },
        {
            ...
            content:'총 16주에 걸쳐 선배들이 제공하는 과제로 수업하게 되고 2주마다 공식적인 오프라인 미팅을 갖게 됩니다. 이 떄는 2주간 배운 내용 중 한 부분을 선택해 프레젠테이션을 진행하게 됩니다. 상세 일정은 합격 후 공지해드리도록 하겠습니다',
        },
        {
            id:4,
            title:"플테코 떨어져도 과제 내용 공유해주시면 안 되나요?",
